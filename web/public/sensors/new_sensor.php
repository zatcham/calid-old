...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    updateAccount($currentuserid, $_POST["inp-email"], $_POST["inp-cpassword"], $_POST["inp-npassword"], $_POST["inp-cnpassword"] );
}
?>
...
<head>
    ...
    <title>New sensor - DEV1 - Sensor System</title> <!-- TODO : Dynamic Title -->
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Add new sensor</li>
                </ol>
                <div class="row">
                    <form>
